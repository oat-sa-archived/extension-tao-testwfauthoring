module.exports = function(grunt) { 
     ...
     */
    clean.taowfadvtestbundle = ['output',  root + '/taoWfAdvTest/views/js/controllers.min.js'];
    ...
    copy.taowfadvtestbundle = {
        files: [
            { src: ['output/taoWfAdvTest/controller/routes.js'],  dest: root + '/taoWfAdvTest/views/js/controllers.min.js' },
            { src: ['output/taoWfAdvTest/controller/routes.js.map'],  dest: root + '/taoWfAdvTest/views/js/controllers.min.js.map' }
        ]
    };
